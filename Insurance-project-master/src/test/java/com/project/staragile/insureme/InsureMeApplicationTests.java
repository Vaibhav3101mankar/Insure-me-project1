...
import com.project.insureme.Policy;
import com.project.insureme.PolicyService;
...
class InsureMeApplicationTests {
	...
	void testCreatePolicy() {
		Policy policy = new Policy(1, "vaibhav", "Individual" , 10000, "10-Sep-2021", "10-Sep-2022");
